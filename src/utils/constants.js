...
export const PAYMENT_METHODS = {
  ...
  bank_transfer: { id: 'bank_transfer', label: 'Bank Transfer', icon: 'AccountBalance' },
};
...
export const BANK_DETAILS_SCHEMA = {
  ...
  accountNumber: { required: true, pattern: VALIDATION_RULES.ACCOUNT_NUMBER_REGEX },
...
export const HSN_CODE_DESCRIPTIONS = {
  [HSN_CODES.FLY_ASH_BRICKS]: 'Articles of stone, plaster, cement, asbestos, mica or similar materials - Fly Ash Bricks',
  [HSN_CODES.CLAY_BRICKS]: 'Bricks, blocks, tiles and other ceramic goods of siliceous fossil meals - Clay Bricks',
  [HSN_CODES.CONCRETE_BLOCKS]: 'Articles of cement, of concrete or of artificial stone - Concrete Blocks',
};
