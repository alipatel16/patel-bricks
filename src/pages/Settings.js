...
// You'll need to import your Firebase configuration
...
function Settings() {
  ...
  const [stockAlertThresholds, setStockAlertThresholds] =
    useState(LOW_STOCK_ALERTS);
  ...
  const handleBackupData = async () => {
    ...
    try {
      ...
      if (data) {
        ...
        link.href = url;
        link.download = `${APP_NAME}_backup_${
  ...
  const handleRestoreData = async () => {
    ...
    input.onchange = async (event) => {
      ...
      try {
        ...
        // Here you would restore data to Firebase
  ...
  const handleResetData = async () => {
    ...
    const doubleConfirmed = window.confirm(
      "This will permanently delete ALL production, sales, inventory, and settings data. Are you absolutely sure?"
    );
    ...
    try {
      // Here you would reset all Firebase data
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Box sx={{ display: "flex", gap: 2 }}>
                ...
                <Button variant="outlined" onClick={handleSaveStockAlerts}>
                  Save Stock Alerts
                </Button>
              </Box>
            </Grid>
              ...
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography
                    ...
                    sx={{ mb: 2 }}
                  >
                    Export all your Firebase Realtime Database data as a JSON
                    file for backup or migration purposes.
                  </Typography>
                  <Button
                    variant="contained"
              ...
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Typography
                    ...
                    sx={{ mb: 2 }}
                  >
                    Restore data from a previously exported backup JSON file.
                  </Typography>
                  <Button
                    variant="outlined"
                  ...
                  >
                    {isRestoreLoading ? "Restoring..." : "Select Backup File"}
                  </Button>
                </CardContent>
              </Card>
            </Grid>
              ...
              <Card variant="outlined" sx={{ borderColor: "error.main" }}>
                <CardContent>
                  ...
                  <Typography
                    ...
                    sx={{ mb: 2 }}
                  >
                    This will permanently delete all production, sales,
                    inventory, and settings data from Firebase. This action
                    cannot be undone.
                  </Typography>
                  <Button
                    variant="outlined"
