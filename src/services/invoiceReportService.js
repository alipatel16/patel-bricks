    ...
    try {
      ...
      await runTransaction(db, async (transaction) => {
        ...
        const updates = {
          ...
          billedToName: currentCustomer?.billedToName ?? previous.billedToName ?? '',
          billedToAddress: currentCustomer?.billedToAddress ?? previous.billedToAddress ?? '',
          receiverName: currentCustomer?.receiverName ?? previous.receiverName ?? '',
          receiverAddress: currentCustomer?.receiverAddress ?? previous.receiverAddress ?? '',
          date: invoiceDate,
          fromDate,
          toDate,
          selectedSite,
          ...
          originalInvoiceData: {
            ...
            customerData: {
              ...
              billedToName: currentCustomer?.billedToName ?? previousInvoiceData.customerData?.billedToName ?? previous.billedToName ?? '',
              billedToAddress: currentCustomer?.billedToAddress ?? previousInvoiceData.customerData?.billedToAddress ?? previous.billedToAddress ?? '',
              receiverName: currentCustomer?.receiverName ?? previousInvoiceData.customerData?.receiverName ?? previous.receiverName ?? '',
              receiverAddress: currentCustomer?.receiverAddress ?? previousInvoiceData.customerData?.receiverAddress ?? previous.receiverAddress ?? '',
            },
          },
          searchPrefixes: makeSearchPrefixes(
            gstInvoiceNumber,
